...
[haxes,hline1,hline2] = plotyy([t_his t_his],[ f_his(:,2), tau_his(:,3)], t_his,u_his);
...
legend( 'Force_y','Torque_z','Array Speed 1','Array Speed 2');
...
%movie2avi(vid, './figures/oop_rotation_sim.avi','compression','none');